...
(function () {
  ...
  window.__ModuleLoader__.load({
    ...
    factory: function (require) {
      ...
      /** 备份相关说明的统一文案（面板与工具描述保持同一口径）。 */
      var BACKUP_NOTE = '备份就写在你脚本旁边（`_backup\\`），每次两份：固定名 `<原名>.bak`（最新）+ 一份带本地时间戳的历史（永不自动删）。'
        ...
        var col3 = [
          ...
          React.createElement('div', { className: PLUGIN + '-sec', key: 'secAdv' },
            React.createElement('div', {
              ...
              '高级诊断（探针）',
              React.createElement('span', { className: PLUGIN + '-onlyai' }, 'AI 专用 · 你最好别碰'),
              React.createElement('span', { className: PLUGIN + '-hint' }, advOpen ? '▾' : '▸')),
            React.createElement('div', { className: PLUGIN + '-hint' }, advOpen
              ? '它会临时覆盖你的脚本：试玩那一局你的玩法不会跑。用完记得点「④ 还原我的脚本」。'
              : '平时不用展开。这里的东西是给 AI 排障用的，而且会临时覆盖你的脚本。'),
            advOpen ? React.createElement('div', null, probeKids) : null),
        ];
